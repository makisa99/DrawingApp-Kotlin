...
class MainActivity : AppCompatActivity() {
            ...
            permissions.entries.forEach {
                ...
                if (isGranted) {
                    ...
                    if (permissionName == Manifest.permission.READ_EXTERNAL_STORAGE) {
                        Toast.makeText(
                            this@MainActivity, "You denied the permission.",
                            Toast.LENGTH_LONG
                        ).show()
                    }
                }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val id_undo: Button = findViewById(R.id.id_undo)
        id_undo.setOnClickListener {
            drawingView?.onClickUndo()
        }

        val id_redo: Button = findViewById(R.id.id_redo)
        id_redo.setOnClickListener {
            drawingView?.onClickRedo()
        }

        val id_gallery: Button = findViewById(R.id.id_gallery)
        id_gallery.setOnClickListener {
            requestStoragePermission()
        }

        val id_save: Button = findViewById(R.id.id_save)
        id_save.setOnClickListener {
            if (isReadStorageAllowed()) {
                showProgressDialog()
                lifecycleScope.launch {
                    val flDrawingView: FrameLayout = findViewById(R.id.fl_drwaing_view_container)
    ...
    private fun requestStoragePermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(
            ...
            showRationaleDialog("Drawing", "I need your storage permission")
        } else {
